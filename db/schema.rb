...
ActiveRecord::Schema.define(version: 20160916224828) do
  ...
  create_table "flash_cards", force: :cascade do |t|
    ...
    t.integer  "user_id"
    t.index ["question", "user_id"], name: "index_flash_cards_on_question_and_user_id", unique: true, using: :btree
    t.index ["user_id"], name: "index_flash_cards_on_user_id", using: :btree
  end
